...
2. ### Manually way (no Password protected)
...
### Configuration Options  
  ...
  300 = 5 minutes.  
> [!WARNING]
> Only set this to true once when creating a new world!
  ### StartNewGame
  ...
  "LoadSavedGame": "true"
  ```
  7. Start the server and join it There is no need to use the in-game server manager tool!
